...
namespace CardMatchLogic
{
	...
	public struct CardData{
		...
		public enum FACE { LEFT=1, RIGHT=2, TOP=3}; 
		public int color;
		public int pattern;
		public int sound;
		public int face; 
		...
		public CardData( int Color, int Pattern, int Sound, int Face )
		{
			color = Color;
			pattern = Pattern;
			sound = Sound;
			face = Face; 
			Console.WriteLine(face+ "from carddata"); 
		}
	}
...
// 						spriteName = "leftSide";
						//spriteName = "topSide";
 						//break;
					case(int)CardData.FACE.LEFT:
						spriteName = "leftSide"; 
						Console.WriteLine("leftSide"); 
						break; 
					case(int)CardData.FACE.RIGHT: 
						spriteName = "rightSide"; 
						Console.WriteLine("rightSide"); 
						break; 
					case(int)CardData.FACE.TOP: 
 						spriteName = "topSide"; 
						break; 
