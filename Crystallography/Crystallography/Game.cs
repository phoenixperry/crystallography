...
namespace Crystallography
{
	public class Game
	{
		...
		public void Initialize()
		{
			...
			Title = Support.TiledSpriteFromFile("/Application/assets/header.png", 1, 1);
		...
		public void StartTitle()
		{
			...
			var transition = new TransitionSolidFade(TitleScene) { 
...
//			Support.MusicSystem.Instance.PlayNoClobber("music_ingame.mp3");
			...
			Board.Tick(dt);
			// wait for transition
			if (Director.Instance.CurrentScene != GameScene)
			{
				return;
			}
			// need to add delay buffer here...
//			Input2.TouchData touch = Input2.Touch00;
			Input2.ButtonState touch = Input2.GamePad0.Cross;
			if (touch.Down)
			{
				StartTitle();
			}
