...
//		private static GlitchSpriteSheetSingleton instance; 
...
//		// METHODS ----------------------------------------------------------------------------------------------
//		
//  		public static GlitchSpriteSheetSingleton getInstance(){
//			if( instance ==null ) {
//				isOkToCreate = true; 
//				instance = new GlitchSpriteSheetSingleton(); 
//				isOkToCreate = false; 
////				test++;
